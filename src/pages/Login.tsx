    ...
    <>
      {loading ? (
        ...
        <aside className="flex justify-center items-center flex-col h-[100vh] gap-5 ">
          {msg ? (
            <h3 className="font-Abel text-xl bg-red-700 bg-opacity-100 text-white py-2 px-4">
              {msg}
            </h3>
          ) : null}
          <button
            className="logininwithgoogle py-2 px-5 text-2xl font-Abel text-white bg-blue-800"
            onClick={handlelogin}
          >
            signin with Google
          </button>
